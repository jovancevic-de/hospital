...
export class ExaminationService {
  ...
  saveExamination(item: Examination): Observable<Examination> {
    if (item.id) {
      return this.httpClient.put<Examination>(this.examinationUrl + "/api/examinations/" + item.id, item);
    } else {
      return this.httpClient.post<Examination>(this.examinationUrl + "/api/examinations/", item);
    }
  }
